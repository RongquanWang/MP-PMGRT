...
# from model_pre import TripleModel_Catt_ablation as MODEL
from model_pre import TripleModel_Catt_ablation2 as MODEL
from Loss import *
...
def main(save_path):
    ...
    model = MODEL(text_neighbor=text_neighbor, max_len=max_len)
...
if __name__ == "__main__":
    ...
    times = 3
    batch_size = 128
    text_neighbor, max_len = 2, 13
    from utils import myDataset as DATASET

    res = []
    LOSSFUNC = GL_lossFunc
    print(LOSSFUNC.__name__)
    # save_path = './result/final_{}/{}'
    # save_path = './result/CFIv2_xlstmv_{}/{}'
    # save_path = './result/CFIv2_wav2clip_{}/{}'
    # save_path = './result/CFIv2_clipt_{}/{}'
    # save_path = './result/CFIv2_clipwav_{}/{}'
    # save_path = './result/CFIv2_clipclip_{}/{}'
    # save_path = './result/UDIVA_xlstmv_{}/{}'
    # save_path = './result/UDIVA_wav2clip_{}/{}'
    # save_path = './result/UDIVA_clipt_{}/{}'
    # save_path = './result/UDIVA_clipwav_{}/{}'
    # save_path = './result/UDIVA_clipclip_{}/{}'

    # save_path = './result/CFIv2_V+VA_{}/{}'
    # save_path = './result/CFIv2_V+VT_{}/{}'
    # save_path = './result/CFIv2_A+T_{}/{}'
    # save_path = './result/UDIVA_V+VA_{}/{}'
    # save_path = './result/UDIVA_V+VT_{}/{}'
    # save_path = './result/UDIVA_A+T_{}/{}'

    # save_path = './result_RNN/CFIv2_RNN_{}/{}'
    # save_path = './result_RNN/CFIv2_BiRNN_{}/{}'
    # save_path = './result_RNN/CFIv2_GRU_{}/{}'
    # save_path = './result_RNN/CFIv2_BiGRU_{}/{}'
    # save_path = './result_RNN/CFIv2_LSTM_{}/{}'
    # save_path = './result_RNN/CFIv2_BiLSTM_{}/{}'
    # save_path = './result_RNN/UDIVA_RNN_{}/{}'
    # save_path = './result_RNN/UDIVA_BiRNN_{}/{}'
    # save_path = './result_RNN/UDIVA_GRU_{}/{}'
    save_path = './result_RNN/UDIVA_BiGRU_{}/{}'
    # save_path = './result_RNN/UDIVA_LSTM_{}/{}'
    # save_path = './result_RNN/UDIVA_BiLSTM_{}/{}'


    # save_path = './result_loss/CFIv2_rmse_{}/{}'
    # save_path = './result_loss/CFIv2_bell_{}/{}'
    # save_path = './result_loss/CFIv2_logcosh_{}/{}'
    # save_path = './result_loss/CFIv2_gl_{}/{}'
    # save_path = './result_loss/UDIVA_rmse_{}/{}'
    # save_path = './result_loss/UDIVA_bell_{}/{}'
    # save_path = './result_loss/UDIVA_logcosh_{}/{}'
    # save_path = './result_loss/UDIVA_gl_{}/{}'

    # save_path = './result_loss/CFIv2_rmse_bell_{}/{}'
    # save_path = './result_loss/CFIv2_rmse_logcosh_{}/{}'
    # save_path = './result_loss/CFIv2_rmse_gl_{}/{}'
    # save_path = './result_loss/UDIVA_rmse_bell_{}/{}'
    # save_path = './result_loss/UDIVA_rmse_logcosh_{}/{}'
    # save_path = './result_loss/UDIVA_rmse_gl_{}/{}'

    # save_path = './result_loss/CFIv2_{}_{}/{}'
    # save_path = './result_loss/UDIVA_{}_{}/{}'
    if 'UDIVA' in save_path:
        batch_size = 64
        text_neighbor, max_len = 10, 452
        from utils import myDataset_UDIVA as DATASET

    print(save_path)
    for i in range(times):
        path = save_path.format(ind, i)
        # path = save_path.format(LOSSFUNC.__name__.lower(), ind, i)
        print(path)
        # 训练和验证
        # if i != 0:
        #     main(path)
    ...
    for r in res:
        ...
        print(f'ACC: {r[4]:.4f} | PCC: {r[5]:.4f} | CCC: {r[6]:.4f} | R2: {r[7]:.4f} | mean: {meant:.4f}')
    res = np.mean(res, axis=0)
    print(
        f'Test Mean: ACC: {res[4]:.4f} | PCC: {res[5]:.4f} | CCC: {res[6]:.4f} | R2: {res[7]:.4f} | mean: {np.mean(res[4:]).item():.4f}')
    ...
    #     print(f'{i} =======================================================================')
    #     acc_mean, pcc_mean, ccc_mean, R2_mean = test(path, 'test')
    #     res.append((acc_mean, pcc_mean, ccc_mean, R2_mean))
    #     meant = (acc_mean + pcc_mean + ccc_mean + R2_mean) / 4
    #     print(f'ACC: {acc_mean:.4f} | PCC: {pcc_mean:.4f} | CCC: {ccc_mean:.4f} | R2: {R2_mean:.4f} | mean: {meant:.4f}')
    # res = np.mean(res, axis=0)
    # print(f'Test Mean: ACC: {res[0]:.4f}| PCC: {res[1]:.4f} | CCC: {res[2]:.4f} | R2: {res[3]:.4f} | mean: {np.mean(res).item():.4f}')
